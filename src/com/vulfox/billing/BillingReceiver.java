...
public class BillingReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
    	...
    	Logger.log("Got an intent in BillingReceiver:" + intent);
    	
        String action = intent.getAction();
        
        Logger.log("Got an action in BillingReceiver:" + action);
        
        if (BillingConstants.ACTION_PURCHASE_STATE_CHANGED.equals(action)) {
        	Logger.log("Got an action in BillingReceiver:" + BillingConstants.ACTION_PURCHASE_STATE_CHANGED);
        	...
        	Logger.log("Got an action in BillingReceiver:" + BillingConstants.ACTION_NOTIFY);
        	...
        	Logger.log("Got an action in BillingReceiver:" + BillingConstants.ACTION_RESPONSE_CODE);
